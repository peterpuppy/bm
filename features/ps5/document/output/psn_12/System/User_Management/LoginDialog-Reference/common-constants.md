...
Source: https://game.develop.playstation.net/resources/documents/SDK/12.000/LoginDialog-Reference/common-constants.html

# Common Constants

# Return Codes

List of return codes returned by the LoginDialog library
...
| `SCE_LOGIN_DIALOG_ERROR_INVALID_USER_ID` | 0x81340007 | User ID is invalid |