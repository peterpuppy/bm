...
Source: https://game.develop.playstation.net/resources/documents/SDK/12.000/SigninDialog-Reference/return-codes.html

# Common Constants

# Return Codes

List of return codes returned by the SigninDialog library
...
| `SCE_SIGNIN_DIALOG_ERROR_INVALID_USER_ID` | 0x81350007 | User ID is invalid |